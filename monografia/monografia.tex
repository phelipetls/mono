...
\section{Testes econométricos}
    ...
    Se tratando de análises de séries temporais, é preciso antes de tudo que se faça os testes de estacionariedade para cada série. Dentre as opções, foi escolhido o teste Augmented Dickey-Fuller, 
