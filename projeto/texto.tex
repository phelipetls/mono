...
\section{Revisão da literatura teórica}
    ...
    banco como uma firma maximizadora de lucros de \citeonline{klein}, o modelo
    do banco como intermediador financeiro de \citeonline{hoesaunders} e,
...
\subsection{O banco como intermediador financeiro}
    ...
    Neste modelo, primeiro apresentado em \citeonline{hoesaunders}, o banco é
    ...
    de \citeonline{maudos}.

    Este modelo difere radicalmente do de \citeonline{klein} no que tange ao
    ...
    ver \citeonline[p.~2262]{maudos} ou \citeonline[p.~584]{hoesaunders}. Para
...
\section{Revisão da literatura empírica}
    ...
    \citeonline{afanasieff02} notam que além da grande variação temporal do
    ...
    \citeonline{hoesaunders}, usando dados mensais de 142 bancos brasileiros
    ...
    Seguindo linha metodológica parecida, \citeonline{bignotto06} também se
    utilizam do modelo teórico de \citeonline{hoesaunders} para analisar a
    ...
    \citeonline{nakane02} buscaram investigar a sensibilidade do spread a
